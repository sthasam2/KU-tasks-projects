...
int main(){
        ...
        do{
                ...
                case 1: {
                        int predecessor;
                        std::cout << endl << "Please enter the data : ";
                        std::cin >> data;
                ...
                case 2: {
                        std::cout << endl << "Please enter the data to add to HEAD: ";
                        std::cin >> data;
                        l.addToHead(data);
                ...
                case 3: {
                        std::cout << endl << "Please enter the data to add to TAIL: ";
                        std::cin >> data;
                        if (l.isEmpty()) { //if empty tail=nullptr and nullptr cannot store newnode
                                l.addToHead(data);
                        }
                        else {
                                l.addToTail(data);
                ...
                case 4: {
                        std::cout << endl << "Please enter the data to remove: ";
                        std::cin >> data;
                        found = l.search(data);
                        if (found) {
                                l.remove(data);
                ...
                case 5: {
                        if (l.isEmpty()) {
                                ...
                                l.removeFromHead();
                                std::cout << endl << "***Successfully removed data from HEAD***";
                        }
                        break;
                }

                case 6: {
                        std::cout << endl << "Enter the data to be searched: ";
                        std::cin >> data;
                        found = l.search(data);
                        if (found) {
                ...
                case 7: {
                        std::cout << endl << "Enter the data to be retrieved: ";
                        std::cin >> data;
                        found = l.search(data);
                        if (found) {
