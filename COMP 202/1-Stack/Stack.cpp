...
int stack::top() {
								if (!isEmpty()) return elements[topp];
								else {
																return elements[topp];
								}
}
...
int main() {
								...
								for (i; i < MAX_STACK_SIZE; i++) {
																...
																case 1: int data; std::cout << "Element no. " << i + 1 << "\tPush element: "; std::cin >> data;
																								a.push(data);
																								if(!a.isFull()) std::cout << "/// Pushed " << data << " ///";
																								break;
																...
																case 3:
																								...
																								if (!a.isEmpty()) std::cout << a.top() << endl;
