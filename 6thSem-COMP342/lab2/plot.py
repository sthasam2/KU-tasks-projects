...
def random_color():
    return (_get_random_float(), _get_random_float(), _get_random_float(), 0.8)
...
def startPolygonPlot(title: str, polygons: list):
    global Polygons, EnableAxes
    Polygons = polygons
    EnableAxes = 1
